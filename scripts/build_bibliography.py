...
DEFAULT_PAPERPILE = Path("/Users/mizuy/lab/vault/paperpile.bib")
FALLBACK_PAPERPILE_PATHS: tuple[Path, ...] = (
    Path("/Users/mizuy/My Drive/paperpile.bib"),
...
def resolve_paperpile_bib(explicit: Path | None = None) -> Path:
    ...
    if env:
        ...
        if path.is_file():
            return path
    for candidate in (DEFAULT_PAPERPILE, *FALLBACK_PAPERPILE_PATHS):
